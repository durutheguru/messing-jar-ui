<template>
    ...
    <div id="group-chat-header-descriptor" class="flex flex-col gap-1 p-3 mr-4">
        <div class="text-3xl">Group Name</div>
        <div class="lg:text-lg grid grid-cols-5 md:grid-cols-6 lg:grid-cols-12">
            <div class="col-span-1 md:col-span-1 lg:col-span-1 h-full grow md:pt-4 pt-4">
                <span class=" h-full">23 members</span>
            </div>
            <div class="col-span-4 md:col-span-5 lg:col-span-11 pl-5 pr-1">
                <v-list class="flex flex-row gap-0">
                    <v-list-item style="padding:0px;" v-for="(i, index) in 50" :key="index"
    ...
    <message-timeline style="margin-top:9em" />
